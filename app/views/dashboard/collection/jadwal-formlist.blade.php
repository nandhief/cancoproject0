...
<div class="page-header">
  ...
  <div class="breadcrumb-line">
    <ul class="breadcrumb">
      ...
      <li class="active"><i class="icon-calendar2"></i> Jadwal Penagihan</li>
    </ul>
    <!--
...
<div class="content">
  <div class="panel panel-flat">
    <div class="panel-heading">
      <h5 class="panel-title text-semibold" style="color: #bb0a0a !important">Unggah File Jadwal Penagihan</h5>
      <div class="heading-elements">
        <ul class="icons-list">
          <li><a href="<?php echo asset_url(); ?>/assets/documents/sample_jadwal1.xlsx"><i class="  icon-download4"></i> Download File Contoh</a></li>
    ...
    <div class="panel-body">
      <p class="content-group">
        Unggah file Excel berisi jadwal penagihan.
      </p>

      <p class="content-group">
        Harap pastikan isi dan format file sudah benar. Setelah diunggah, jadwal akan diunduh oleh aplikasi mobile petugas lapangan.
      </p>

      <form class="form-horizontal" enctype="multipart/form-data" method="post" id="formUploadData" name="formUploadData" action="<?php echo asset_url(); ?>/collection/jadwal-penagihan">
        <div class="form-group">
          <!--<label class="col-lg-2 control-label text-semibold">File Data Format Excel</label>-->
          <div class="col-lg-4">
            <input type="file" class="file-input" data-show-preview="false" data-show-upload="false" id="jdwFile" name="jdwFile" placeholder="File format Excel...">
          </div>
        </div>
  ...
  <div class="panel panel-flat border-top-primary">
    <div class="panel-heading">
      <h5 class="panel-title text-semibold" style="color: #bb0a0a !important">Data Jadwal Penagihan</h5>
      <!--
      <div class="heading-elements">
        <ul class="icons-list">
          ...
          <table class="table datatable-basic" style="font-size:90%;">
            <thead>
              <tr>
                ...
                <th style="text-align:center" width="15%">Total Pembayaran</th>
              ...
              if(isset($ctlUploads) && count($ctlUploads) > 0) {
                foreach ($ctlUploads as $aData) {
                  ...
                  <tr <?php echo $highlight; ?>>
                    ...
                    <td style="text-align:center;">Rp. <?php echo number_format($aData->{"JUMLAH_TAGIHAN"}); ?></td>
                    <td style="text-align:center;">Rp. <?php echo number_format($aData->{"JUMLAH_BAYAR"}); ?></td>
...
<script type="text/javascript">
  ...
  function reloadPage() {
    ...
    window.location = "<?php echo asset_url(); ?>/collection/jadwal-penagihan?periode=" + filterPeriode;
  }
  ...
  function showDetail(buId) {
    window.location = "<?php echo asset_url(); ?>/collection/jadwal-penagihan/" + buId;
  }
</script>
@stop
