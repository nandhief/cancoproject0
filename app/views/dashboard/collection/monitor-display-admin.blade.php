    ...
    <div class="col-md-12">
      <div class="panel panel-flat">
        <div class="panel-heading">
          <h5 class="panel-title" style="color: #bb0a0a !important">Lokasi Check-In Collector Jadwal Penagihan</h5>
        </div>
            ...
            <div class="row">
              <div class="col-sm-8">
               ...
               <!--  <div class="input-group">
                    ...
                    <input type="text" id="jadwal" onchange="reloadCollectionData()" class="form-control datepicker" data-date-format="dd-mm-yyyy" placeholder="Pick a date&hellip;">
                  </div> -->
                <br>
