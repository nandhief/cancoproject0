...
<div class="page-header">
  <div class="page-header-content">
    <div class="page-title">
      <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold" style="color: #bb0a0a !important">List Jadwal Penagihan</span></h4>
    </div>
    <!--
          ...
          <table class="table datatable-basic" style="font-size:90%;">
            <thead>
              <tr>
                ...
                <th style="text-align:center" width="15%">Perusahaan</th>
...
<script type="text/javascript">
  $(function() {
    $('.filterPeriode').on('click', function () {
      ...
      window.location = "<?php echo asset_url(); ?>/admin/collection/jadwal?dari=" + dari + "&sampai=" + sampai;
    });
  ...
  function reloadPage() {
    ...
    window.location = "<?php echo asset_url(); ?>/admin/collection/jadwal?periode=" + filterPeriode;
  }
    ...
    function(){
      ...
      $.ajax({
        ...
        success : function(result) {
          ...
          if(data["STATUS"] == "SUCCESS") {
            toastr.success(data["MESSAGE"]);
            window.location = "<?php echo asset_url(); ?>admin/collection/jadwal";
          }
          else {
            toastr.error(data["MESSAGE"]);
          }
