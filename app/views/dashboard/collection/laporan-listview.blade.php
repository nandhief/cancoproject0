...
<div class="content">
  <div class="panel panel-flat border-top-primary">
        ...
        <table class="table table-bordered datatables">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?= tglIndo($value->J_TGL, "SHORT") ?></td>
              <td><?= $value->U_NAMA ?></td>
    ...
    <div class="panel-footer">
      <a href="<?php echo asset_url(); ?>/collection/laporan" class="btn btn-warning"><i class="fa fa-fw fa-reply"></i>Kembali</a>
      <a href="<?php echo asset_url(); ?>/collection/laporan/download?<?= Request::server('QUERY_STRING') ?>" class="btn btn-primary"><i class="fa fa-fw fa-download"></i>Unduh File</a>
    </div>
  </div>
</div>
