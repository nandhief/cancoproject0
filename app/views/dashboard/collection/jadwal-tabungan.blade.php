...
<div class="content">
  <div class="panel panel-flat">
    <div class="panel-heading">
      <h5 class="panel-title text-semibold" style="color: #bb0a0a !important">Unggah File Tabungan</h5>
      <div class="heading-elements">
        <ul class="icons-list">
          <li><a href="<?php echo asset_url(); ?>/assets/documents/sample_tabungan.xlsx"><i class="  icon-download4"></i> Download File Contoh</a></li>
    ...
    <div class="panel-body">
      <p class="content-group">
        Unggah file Excel berisi jadwal tabungan nasabah.
      </p>

      <p class="content-group">
        Harap pastikan isi dan format file sudah benar. Setelah diunggah, jadwal tabungan akan diunduh oleh aplikasi mobile petugas lapangan/marketing.
      </p>

      <form class="form-horizontal" enctype="multipart/form-data" method="post" id="formUploadData" name="formUploadData" action="<?php echo asset_url(); ?>/collection/tabungan/store">
  ...
  <div class="panel panel-flat border-top-primary">
    <div class="panel-heading">
      <h5 class="panel-title text-semibold" style="color: #bb0a0a !important">Data Jadwal Tabungan</h5>
      <!--
      <div class="heading-elements">
        <ul class="icons-list">
...
<script type="text/javascript">
  ...
  function reloadPage() {
    ...
    window.location = "<?php echo asset_url(); ?>/collection/tabungan?periode=" + filterPeriode;
  }
